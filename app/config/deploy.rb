...
set :deploy_via, :rsync_with_remote_cache # Ils y a plusieurs méthodes de déploiements, nous utilisons la méthode de copy
set :rsync_options, "-az --delete --progress"
